...
from Activity_pstructure.entity.artifact_entity import DataIngestionArtifact
import os
import sys
import pandas as pd
import numpy as np
...
class DataIngestion:
    ...
    def export_collection_as_dataframe(self): ##Read Data from mongodb
        try:
            ...
            if "_id" in df.columns.to_list(): ##In Mongodb additional column is added!
    ...
    def split_data_as_train_test(self,dataframe:pd.DataFrame):
        try:
            ...
            logging.info("Exit from split_data_as_train_test of Data_Ingestion class")

            dir_path = os.path.dirname(self.data_ingestion_config.training_file_path)
            os.makedirs(dir_path,exist_ok=True)
            logging.info(f"Export train test file path")
